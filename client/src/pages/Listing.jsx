          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            ...
            <ul className='text-green-900 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6'>
              ...
              <li className='flex items-center gap-1 whitespace-nowrap '>
                ...
                {listing.availabilityOfWater }
              </li>
              <li className='flex items-center gap-1 whitespace-nowrap '>
                <FaRoad className='text-lg' />
                {listing.distanceFromSchool }
              </li>
            </ul>
            ...
            {currentUser && <CommentForm propertyId={listing._id} onCommentSubmit={handleReloadComments} />}
            <CommentList propertyId={listing._id} reloadComments={reloadComments} />
          </div>
        </div>
      )}
    </main>
