...
export default function StudentPreferenceFormUpdate({setTrigger}) {
  ...
  const [preferences, setPreferences] = useState({
    regularPrice: preference.regularPrice,
    location: preference.location,
    distanceFromSchool: preference.distanceFromSchool,
    availabilityOfWater: preference.availabilityOfWater,
    roomType: preference.roomType,
    apartmentType: preference.apartmentType
  });
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      <h1 className='text-3xl text-center font-semibold my-7'>Update your Prefered Rental Option?</h1>
