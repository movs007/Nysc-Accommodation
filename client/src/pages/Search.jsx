...
import StudentPreferenceFormUpdate from '../components/StudentPreferenceFormUpdate';
  ...
  return (
    <div className='flex flex-col md:flex-row'>
      <PopUp trigger={isTrigger} setTrigger={setIsTrigger} size={"popup-inner"}>
        ...
        <StudentPreferenceFormUpdate setTrigger={setIsTrigger}/>
      </PopUp>
      <div className='p-7  border-b-2 md:border-r-2 md:min-h-screen'>
        ...
        {currentUser && user && user.userType === 'student' &&
            <button onClick={handleBtnClick} className='w-full mt-3 bg-slate-700 text-white p-3 rounded-lg uppercase hover:opacity-95'>
            Edit Prefrence
            </button>
        }
      ...
      <div className='flex-1'>
        {recommendedListings && recommendedListings.length > 0 && (
              <div className=''>
                <div className='my-3'>
                  <h2 className='text-3xl font-semibold border-b p-3 text-slate-700 mt-5'>Recommendation for you...</h2>
